...
echo "asset path is $ASSETS_DIR/$ASSETS_NAME.plutus"
echo "result is in file $ASSETS_DIR/$ASSETS_NAME.addr"
...
echo "script address is $(cat $ASSETS_DIR/$ASSETS_NAME.addr)"