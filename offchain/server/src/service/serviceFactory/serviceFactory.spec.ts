  ...
  describe(`pluginSdkService module`, () => {
    ...
    beforeAll(() => {
      pluginSdkService = pluginSdkServiceUnbound
        (authenticationServiceFactory, userServiceFactory, scriptServiceFactory, cardanoServiceFactory, cardanoKupoServiceFactory)
        ({} as AppConfig)
    ...
    it(`Should return 'PluginSdkService'`, () => {
      ...
      expect(Object.keys(pluginSdkService).length).toEqual(7);
