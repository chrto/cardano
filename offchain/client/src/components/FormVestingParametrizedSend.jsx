...
function FormVestingParametrizedSend({ scriptAddress, getSelectedWalletUtxos, deselectWalletUtxos }) {
  const [formData, setFormData] = useState({ valueAda: 3, deadline: getLocalDateTimeValue() });
  ...
  const handleReset = (e) => {
    e.preventDefault();
    deselectWalletUtxos();
    setFormData({...formData, valueAda: 3, deadline: getLocalDateTimeValue()});
  }
...
export default FormVestingParametrizedSend;