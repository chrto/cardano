...
-- Untyped OnChain Gift validator
--                 DATUM          REDEEMER       SCRIPTCONTEXT
mkGiftValidator :: BuiltinData -> BuiltinData -> BuiltinData -> ()
mkGiftValidator _ _ _ = ()
-- The mkGiftValidator function has to be INLINABLE!
-- To quote and compile it using compile.
{-# INLINABLE mkGiftValidator #-}

validator :: PlutusV2.Validator
validator = PlutusV2.mkValidatorScript $$(compile [|| mkGiftValidator ||])

-- Helper function.
-- Store validator into assets.
saveValidator :: IO()
saveValidator = writeValidatorToFile "./assets/gift.plutus" validator