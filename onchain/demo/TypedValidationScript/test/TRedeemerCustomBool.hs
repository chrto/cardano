...
import qualified RedeemerCustomBool as OnChain
...
main = defaultMain
  $ do
    testGroup
      ...
      [ testGroup
          "HappyPath"
          [ happyPath "User 1 locks and user 2 takes with redeemer MyRedeemer {flag1 = True, flag2 = False}." $ runUnitTest 1 (OnChain.MyRedeemer True False) $ adaValue 150
          , happyPath "User 1 locks and user 2 takes with redeemer MyRedeemer {flag1 = False, flag2 = True}." $ runUnitTest 1 (OnChain.MyRedeemer False True) $ adaValue 150
          , happyPath "User 1 locks 3 transactions and user 2 takes all of them with MyRedeemer {flag1 = True, flag2 = False}." $ runUnitTest 3 (OnChain.MyRedeemer True False) $ adaValue 150
          , happyPath "User 1 locks 3 transactions and user 2 takes all of them with MyRedeemer {flag1 = False, flag2 = True}." $ runUnitTest 3 (OnChain.MyRedeemer False True) $ adaValue 150
          ]
      , testGroup
          "ErrorPath"
          [ errorPath "User 1 locks and user 2 do not takes with redeemer MyRedeemer {flag1 = True, flag2 = True}." $ runUnitTest 1 (OnChain.MyRedeemer True True) $ adaValue 150
          , errorPath "User 1 locks and user 2 do not takes with redeemer MyRedeemer {flag1 = False, flag2 = False}." $ runUnitTest 1 (OnChain.MyRedeemer False False) $ adaValue 150
          ]
      ]
  where
...
---------------------------------------------------------------------------------------------------
------------------------------------------- DATA --------------------------------------------------
validatorScript :: TypedValidator () OnChain.MyRedeemer
...
consumingTransaction :: OnChain.MyRedeemer -> PubKeyHash -> [(TxOutRef, TxOut)] -> Tx
...
testScript :: Bool -> Integer -> OnChain.MyRedeemer -> Value -> Run Bool
...
---------------------------------------------------------------------------------------------------
------------------------------------ UNIT TEST FUNCIONS--------------------------------------------
runUnitTest :: Integer -> OnChain.MyRedeemer -> Value -> Run ()
