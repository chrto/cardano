...
NAME=""
TXIN=""
TX_REFERENCE="185f81e8797da92847a1cb59903551e4b206153f1b3068432d761e5becb4e4a0#0"
COLLATERAL=""
...
function show_help() {
    ...
    echo "  -r, --txref <tx_hash>#<tx_index>        Set the hash and index of script reference transaction. Default is $TX_REFERENCE"
    echo "  -t, --txin <tx_hash>#<tx_index>         Set the hash and index of input transaction."
    echo "  -c, --collateral <tx_hash>#<tx_index>   If this transaction's Plutus script fails, burn these UTXOs as collateral to pay the transaction fee."
...
cardano-cli $ERA transaction build \
    --testnet-magic 2 \
    --tx-in "$TXIN" \
    --spending-tx-in-reference "$TX_REFERENCE" \
    --spending-plutus-script-v2 \
    --spending-reference-tx-in-inline-datum-present \
    --spending-reference-tx-in-redeemer-file "$ASSETS_DIR/unit.json" \
